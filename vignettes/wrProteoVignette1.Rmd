...
Please note that molecular masses may be given in two falvours : Monoisotopic mass and average mass.
...
export organism annotation from UCSC (_readUCSCtable()_) ->  from R export (non-redundant) 'enst'-IDs (_readUCSCtable()_), get UniProt-IDs at UniProt site, save as file and import result (_readUniProtExport()_) -> combine with initial UCSC table (_readUniProtExport()_)
...
[Proteome Discoverer](https://www.thermofisher.com/order/catalog/product/OPTON-30812) is commercial software from [ThermoFisher](https://www.thermofisher.com/).
...
[MaxQuant](https://www.maxquant.org) is free software provided by the [Max-Planck-Insutute](https://www.biochem.mpg.de/), 
...
[Proline](http://proline.profiproteomics.fr/) is free software provided by the [Profi-consortium](http://www.profiproteomics.fr/),

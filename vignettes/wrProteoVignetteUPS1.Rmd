...
## Introduction
This vignette shows how [UPS1](https://www.sigmaaldrich.com/FR/en/product/sigma/ups1)
...
The projcet [proteomics-metadata-standard](https://github.com/bigbio/proteomics-metadata-standard) tries to provide a framework for documenting meta-data as sdrf files.
This data-set has already been added to this effort and all important information can thus be easily directly imported to this analysis.

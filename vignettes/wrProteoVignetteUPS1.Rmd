...
```
As you will see in the interactive window from _browseVignettes()_ , [this package](https://CRAN.R-project.org/package=wrProteo) has 2 vignettes, a more general introductory vignette and this UPS-1 dedicated vignette.
...
Briefly, this experiment aims to evaluate and compare various quantification appoaches of the heterologous _spike-in_ [UPS1](https://www.sigmaaldrich.com/FR/en/product/sigma/ups1) (available from Sigma-Aldrich) in yeast protein extracts as constant matrix. 9 different concentrations of the heterologous _spike-in_ (UPS1) were run in triplicates. The proteins were initially digested by Trypsin and then analyzed by LC-MS/MS in DDA mode. 
...
In the example below both the default annotation as file _'InputFiles.txt'_ and sdrf annotation are available and will be integrated to object produced by the import-function.
...
(see also [proline-core on github](https://github.com/profiproteomics/proline-core)), published by [BouyssiÃƒÂ© et al 2020](https://doi.org/10.1093/bioinformatics/btaa118).
